using CrescentCoffee.Models.TagHelpers;
...
namespace CrescentCoffeeTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@crescentcoffee.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:test@crescentcoffee.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
